...
export class SendPaymentRequest extends jspb.Message {
  ...
  setFeeLimitSat(value: string): void;
...
export class RouteFeeResponse extends jspb.Message {
  getRoutingFeeMsat(): string;
  setRoutingFeeMsat(value: string): void;

  getTimeLockDelay(): string;
  setTimeLockDelay(value: string): void;
...
export class NodeHistory extends jspb.Message {
  ...
  getLastFailTime(): string;
  setLastFailTime(value: string): void;
...
export class PairHistory extends jspb.Message {
  ...
  getMinPenalizeAmtSat(): string;
  setMinPenalizeAmtSat(value: string): void;
