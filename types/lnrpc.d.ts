...
export class LnRpc {
  ...
  public listPeers(args: ListPeersRequest.AsObject): Promise<ListPeersResponse.AsObject>;
  ...
  public listPayments(args: ListPaymentsRequest.AsObject): Promise<ListPaymentsResponse.AsObject>;
  ...
  public stopDaemon(args: StopRequest.AsObject): Promise<StopResponse.AsObject>;
